module USydPhysics
using Distributed
import AcademicClusters: build_julia_command, LOGDIR, to_string, parse_memory,
    parse_walltime, memory_string_to_gb, with_heap_hint, capture_jobid,
    write_exprs, next_runscripts_id, default_project
